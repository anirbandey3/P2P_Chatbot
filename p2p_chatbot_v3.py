...
def extract_table_info(query):
    ...
    if table_candidates:
        ...
        # Sort by length (longer names more likely to be tables)
        ...
        # Determine schema based on match or table prefix
        if schema_match:
            schema_name = schema_match.group(1)
        elif table_name.startswith("GL_"):
            schema_name = "GL"
        elif table_name.startswith("AP_"):
            schema_name = "AP"
        elif table_name.startswith("AR_"):
            schema_name = "AR"
        elif table_name.startswith("PO_"):
            schema_name = "PO"
        elif table_name.startswith("FA_"):
            schema_name = "FA"
        elif table_name.startswith("HR_"):
            schema_name = "HR"
        elif table_name.startswith("INV_"):
            schema_name = "INV"
        elif table_name.startswith("CE_"):
            schema_name = "CE"
        else:
            schema_name = "AP"  # Default schema
